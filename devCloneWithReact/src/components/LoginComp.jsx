  ...
  return (
    <div className='create-acc-main-div'>
      ...
      <div className='flex  flex-col gap-4 w-5/12 login-page-input'>
        ...
        <input type="email" name='email' className='w-full rounded-lg border-2 border-grey-900 h-10 focus:outline-none focus:border-blue-800 hover:border-3 hover:border-grey-950 px-4' />
        <label htmlFor="password">Password</label>
        <input type="password" name='password' className='w-full rounded-lg border-2 border-grey-900 h-10 focus:outline-none focus:border-blue-800 hover:border-3 hover:border-grey-900 px-4'/>
      </div>

      <div className='flex justify-between w-5/12 my-2 login-page-input'>
        <div className='flex gap-2 items-center'>
        <input type="checkbox" name='remember' className='w-4 h-4 rounded-md' />
      ...
      <button className='bg-blue-800 w-5/12 text-white rounded-md h-11 mt-5 login-page-input'>log in</button>
